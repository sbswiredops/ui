export default function Contact() {
  return (
    <div className="bg-gray-900 text-white">
      ...
      <section className="contact-gradient px-6 pt-16 pb-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-3 text-white">
            Get in Touch
          </h1>
          <p className="text-white/90 md:text-lg mb-8">
            Have a question or need support? Our team is here to help. Please
            fill out the form below, and we’ll get back to you within 24
            business hours.
          </p>

          {/* Contact Form Card */}
          <div className="bg-gray-900/90 rounded-2xl p-6 md:p-8 border border-gray-700 shadow-lg">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="mb-8">
            <h3 className="text-xl font-semibold mb-2">
              Support Email:{" "}
              <span className="text-yellow-400">support@streamify.com</span>
            </h3>
